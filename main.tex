% Author: LeyuDame
% Date: 2026-02-01
% Github: https://github.com/YZDame/BNUslides2026
% Overleaf: 使用的是2024的旧版, 不再更新

% !TeX program = xelatex->bibtex->xelatex->xelatex
...
\begin{frame}{制作愿景}
	\begin{enumerate}
		...
		\item 用起来简单一些：编译方式为\texttt{xelatex-bibtex-xelatex-xelatex}, 语法与图书馆官方毕业论文模板一致, 方便内容迁移
		\item 师大蓝纯正一些：后面有讲
	\end{enumerate}
\end{frame}
...
\begin{frame}{其他block样式}
	\begin{example}[高斯随机变量的尾分布]
		...
		\end{equation}
		由Chernoff ineq\cite{einstein1905}\cite{knuth1984}., 有
		\begin{equation}
	...
	\end{example}
	\begin{alertblock}{注}
		其中\eqref{高斯随机变量的尾分布}式在一个多项式因子的修正后是sharp的\cite{lamport1994}.
	\end{alertblock}
\end{frame}
...
% 参考文献附录（使用 \appendixnumberbeamer 后不会计入总页数）
